...
const DeploymentStep3: React.FC<DeploymentStep3Props> = ({ onClose, objectId }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg w-[250px] text-center">
      ...
      <div className="flex gap-4 bg-gray-100 dark:bg-gray-700 rounded p-4 mb-8 text-sm text-left">
          ...
          <span className="text-gray-700 dark:text-gray-300 break-all"><Copy size={16} />{objectId}</span>
      </div>
