...
const RenewStep2: React.FC<RenewStep2Props> = ({
  onConfirm,
  onCancel,
  isProcessing = false,
  ...
  return (
    <div className="p-2 bg-white dark:bg-gray-800 rounded-lg w-full text-center">
      <img src={deployIcon} alt="Confirm Registration" className="w-20 h-20 mx-auto mb-4" />
      <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Confirm Renewal Details</h2>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
        Please review the details for renewing "<strong>{domainName}</strong>" for {durationYears} year(s).
      </p>
      ...
      <div className="flex justify-center gap-3">
        ...
        <Button variant="primary" onClick={onConfirm} disabled={isProcessing}>
          {isProcessing ? 'Processing...' : 'Renew NS'}
        </Button>
